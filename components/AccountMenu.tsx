...
export default function AccountMenu() {
  ...
  return (
    <div className="relative shrink-0">
      <button
        onClick={() => setOpen((v) => !v)}
        className="flex items-center gap-1.5 text-gray-600 hover:text-brand transition-colors whitespace-nowrap"
      >
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1.5 bg-white border border-black/5 rounded-xl shadow-md py-1 min-w-[8rem] z-40">
          <button
